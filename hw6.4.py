...
if __name__ == '__main__':
    ...
    lecture_1 = Lecturer(name='Alex', surname='Bardin')
    lecture_2 = Lecturer(name='Serg', surname='Vertepov')

    lecture_1.courses_attached += ['Python']
    lecture_2.courses_attached += ['Git']

    reviewer_1 = Reviewer(name='Evgeny', surname='Varlamov')
    reviewer_2 = Reviewer(name='Igor', surname='Chebotar')
